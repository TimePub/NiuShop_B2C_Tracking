<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:37:"template/adminblue\Auth\userList.html";i:1522739314;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<table class="mytable">
	<tr>
		<td style="text-align: left;"><button class="btn-common" onclick="location.href='<?php echo __URL('ADMIN_MAIN/auth/adduser'); ?>';" style="margin:0 !important;">添加用户</button></td>
		<td>
				...
				$.ajax({
					...
					success : function(data) {
						if(data["code"] > 0 ){
							...
							location.href = "<?php echo __URL('ADMIN_MAIN/auth/userlist'); ?>";
						}else{
