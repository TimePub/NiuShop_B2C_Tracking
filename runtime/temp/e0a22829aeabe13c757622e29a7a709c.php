<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:44:"template/adminblue\Config\copyrightinfo.html";i:1522406836;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
		...
		<dd>
			<div class="upload-btn-common">
				<div>
					...
					<input type="hidden" id="logo" value="<?php echo $info['copyright_logo']; ?>" />
				</div>
				<input type="text" id="text_logo" class="input-common" readonly="readonly" value="<?php if($info['copyright_logo']): ?><?php echo $info['copyright_logo']; endif; ?>" />
				<em>上传</em>
				
				<img id="preview_logo" src="__STATIC__/blue/img/upload-common-select.png" <?php if($info['copyright_logo']): ?>data-src="<?php echo __IMG($info['copyright_logo']); ?>"<?php endif; ?> data-html="true" data-container="body" data-placement="top" data-trigger="manual"/>
	...
	<dl>
		<dt>公司名称：</dt>
		<dd>
			<input id="companyname" type="text" value="<?php echo $info['copyright_companyname']; ?>" class="input-common long" />
<!-- 			<p class="hint">Description出现在页面头部的Meta标签中，用于记录本页面的摘要与描述，建议不超过80个字</p> -->
	...
	<dl>
		<dt>版权链接：</dt>
		<dd>
			<input id="link" type="text"  value="<?php echo $info['copyright_link']; ?>" class="input-common long" />
<!-- 			<p class="hint">Keywords项出现在页面头部的标签中，用于记录本页面的关键字，多个关键字请用分隔符分隔</p> -->
	...
	<dl>
		<dt>版权信息：</dt>
		<dd>
			<textarea id="desc" class="textarea-common" maxlength="50"><?php echo $info['copyright_desc']; ?></textarea>
