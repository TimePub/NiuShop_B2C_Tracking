<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:46:"template/adminblue\Goods\addGoodsCategory.html";i:1522404994;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	...
	<dl>
		...
		<dd>
			<select name="attr" id="attr_id" class="select-common">
				...
				<?php if(is_array($goodsAttributeList) || $goodsAttributeList instanceof \think\Collection || $goodsAttributeList instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsAttributeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<option value="<?php echo $vo['attr_id']; ?>"><?php echo $vo['attr_name']; ?></option>
				<?php endforeach; endif; else: echo "" ;endif; ?>
			</select>
		</dd>
	</dl>
	...
	<dl>
		<dt>电脑端分类页面模板：</dt>
		<dd>
			<?php echo $template_url['pc_template_url']; ?>&nbsp;<input type="text" class="input-common harf" name="" id="pc_custom_template" style="width: 80px;" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')">&nbsp;.html
	...
	<dl>
		<dt>手机端分类页面模板：</dt>
		<dd>
			<?php echo $template_url['wap_template_url']; ?>&nbsp;<input type="text" class="input-common harf" name="" id="wap_custom_template" style="width: 80px;" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')">&nbsp;.html
