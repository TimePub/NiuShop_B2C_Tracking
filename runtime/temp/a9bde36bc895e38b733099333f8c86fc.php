<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:43:"template/adminblue\Config\notifyConfig.html";i:1522739314;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<table class="table-class">
	...
	<tbody>
		<?php if(is_array($notify_list) || $notify_list instanceof \think\Collection || $notify_list instanceof \think\Paginator): $k = 0; $__LIST__ = $notify_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$notify_obj): $mod = ($k % 2 );++$k;?>
		<tr>
			<td>
				...
				<span class="table-pay"><?php echo $notify_obj['notify_name']; ?></span><br/>
				<?php if($k == 2): ?>
			...
			<?php if($notify_obj['is_use'] == 1): ?>
			<td style="text-align: center;line-height:59px;margin-left:0px;"  class="is_use_<?php echo $notify_obj['id']; ?>">
			...
			<td style="text-align: center;">
					...
					<?php if($notify_obj['key'] == 'EMAILMESSAGE'): ?>
					<span>
						<a href="<?php echo __URL('ADMIN_MAIN/config/messageconfig','type=email'); ?>">配置</a></span>
					<?php else: ?>
						<span><a href="<?php echo __URL('ADMIN_MAIN/config/messageconfig','type=sms'); ?>">配置</a></span>
					<?php endif; if($notify_obj['key'] == 'EMAILMESSAGE'): ?>
					<span><a href="<?php echo __URL('ADMIN_MAIN/config/notifytemplate','type=email'); ?>">模板</a></span>
					<?php else: ?>
					<span><a href="<?php echo __URL('ADMIN_MAIN/config/notifytemplate','type=sms'); ?>">模板</a></span>
					<?php endif; if($notify_obj['key'] == 'EMAILMESSAGE'): if($notify_obj['is_use'] == 1): ?>
						<span class="is_close_<?php echo $notify_obj['id']; ?>"><a href="javascript:;" onclick="setIsUse(<?php echo $notify_obj['id']; ?>,0);">关闭</a></span>
						<?php else: ?>
						<span class="is_close_<?php echo $notify_obj['id']; ?>"><a href="javascript:;" onclick="setIsUse(<?php echo $notify_obj['id']; ?>,1);">开启</a></span>
						<?php endif; else: if($notify_obj['is_use'] == 1): ?>
						 <span class="is_close_<?php echo $notify_obj['id']; ?>"><a href="javascript:;" onclick="setIsUse(<?php echo $notify_obj['id']; ?>,0);">关闭</a></span>
						<?php else: ?>
						 <span  class="is_close_<?php echo $notify_obj['id']; ?>"><a href="javascript:;" onclick="setIsUse(<?php echo $notify_obj['id']; ?>,1);">开启</a></span>
						<?php endif; endif; ?>
					...
					<br/>
					<?php if($notify_obj['key'] == 'EMAILMESSAGE'): ?>
					<span><a href="<?php echo __URL('ADMIN_MAIN/config/businessnotifytemplate','type=email'); ?>">商家通知</a></span>
					<span><a href="<?php echo __URL('ADMIN_MAIN/config/notifylist','type=2'); ?>">通知记录</a></span>
					<?php else: ?>
					<span><a href="<?php echo __URL('ADMIN_MAIN/config/businessnotifytemplate','type=sms'); ?>">商家通知</a></span>
					<span><a href="<?php echo __URL('ADMIN_MAIN/config/notifylist','type=1'); ?>">通知记录</a></span>
					<?php endif; ?>
					
			</td>
		</tr>
			<!-- <tr style="border:1px solid #e5e5e5;border-top:0;background:none;">
				<td style="background:none;text-align:left;"><?php echo $notify_obj['notify_name']; ?></td>
				<?php if($notify_obj['is_use'] == 1): ?>
				<td style="text-align: center;background:none;" class="is_use_<?php echo $notify_obj['id']; ?>"><img src="ADMIN_IMG/checked.png" alt="" width="15"/></td>
				<?php else: ?>
				<td style="text-align: center;background:none;"><img src="ADMIN_IMG/un_checked.png" alt="" width="15"/></td>
				<?php endif; ?>
...
function setIsUse(id,value){
	...
	$.ajax({
		type : "post",
		url: "<?php echo __URL('ADMIN_MAIN/config/updatenotifyenable'); ?>",
