<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:45:"template/adminblue\Wchat\materialMessage.html";i:1522727994;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<tr>
	<th width="20%" style="text-align: left;">
		<?php if(!empty($type)): ?>
		<button class="btn-common btn-small" style="margin:0 5px 0 0 !important;" onclick="location.href='<?php echo __URL('ADMIN_MAIN/wchat/addmedia?type='.$type); ?>';">添加<?php echo $type_name; ?>消息</button>
		<?php endif; ?>
	</th>
	<th width="10%">
					...
					$.ajax({
						...
						success : function(res){
							if(res>0){
								...
								location.href = "<?php echo __URL('ADMIN_MAIN/wchat/materialmessage?type='.$type); ?>";
							}else{
								showTip("操作成功",'error');
							}
						}
