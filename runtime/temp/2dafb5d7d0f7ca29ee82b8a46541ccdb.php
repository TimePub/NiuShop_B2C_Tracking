<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:42:"template/adminblue\Config\loginConfig.html";i:1523333627;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		<dt>APP_ID：</dt>
		<dd><input id="APP_KEY" type="text" value="<?php echo $qq_config['value']['APP_KEY']; ?>" class="input-common long" /></dd>
	</dl>
	<dl>
		<dt>APP_KEY：</dt>
		<dd><input id="APP_SECRET" type="text" value="<?php echo $qq_config['value']['APP_SECRET']; ?>" class="input-common long" /></dd>
	</dl>
	<dl>
		<dt>是否启用：</dt>
		<dd>
			<input id="is_use" type="checkbox" class="checkbox" <?php if($qq_config['is_use']=='1'): ?>checked="checked"<?php endif; ?>/>
		</dd>
	</dl>
	<dl>
		<dt>申请域名：</dt>
		<dd>
			<?php echo $qq_config['value']['AUTHORIZE']; ?>
		</dd>
	</dl>
	<dl>
		<dt>回调域名：</dt>
		<dd><?php echo $qq_config['value']['CALLBACK']; ?></dd>
	</dl>
	<dl>
		<dt></dt>
		<dd>
...
<input type ="hidden" id="AUTHORIZE" value="<?php echo $qq_config['value']['AUTHORIZE']; ?>">
<input type ="hidden" id="CALLBACK" value="<?php echo $qq_config['value']['CALLBACK']; ?>">
<script>
function setConfigAjax(){
	...
	$.ajax({
		type:"post",
		url:"<?php echo __URL('ADMIN_MAIN/config/loginqqconfig'); ?>",
		data:{
			'appkey':appkey,
			'appsecret':appsecret,
			'url':url,
		...
		success:function (data) {
			if (data["code"] > 0) {
				...
				location.href = "<?php echo __URL('ADMIN_MAIN/config/partylogin'); ?>";
			}else{
...
<div class="set-style">
	<dl>
		<dt>APP_KEY：</dt>
		<dd><input id="APP_KEY" type="text" value="<?php echo $wchat_config['value']['APP_KEY']; ?>" class="input-common long" /></dd>
	</dl>
	<dl>
		<dt>APP_SECRET：</dt>
		<dd><input id="APP_SECRET" type="text" value="<?php echo $wchat_config['value']['APP_SECRET']; ?>" class="input-common long" /></dd>
	</dl>
	<dl>
		<dt>是否启用：</dt>
		<dd>
			<input id="is_use" type="checkbox" class="checkbox" <?php if($wchat_config['is_use']=='1'): ?>checked="checked"<?php endif; ?>/>
		</dd>
	</dl>
	<dl>
		<dt>申请域名：</dt>
		<dd>
		<?php echo $wchat_config['value']['AUTHORIZE']; ?>
		<p class="hint">(申请<a href="https://open.weixin.qq.com/" target="_blank">微信开放平台</a> 网站应用,授权回调域:<?php echo $_SERVER['HTTP_HOST']; ?>)</p>
		</dd>
	</dl>
	<dl>
		<dt>回调域名：</dt>
		<dd><?php echo $wchat_config['value']['CALLBACK']; ?></dd>
	</dl>
	<dl>
		<dt></dt>
		<dd>
...
<input type ="hidden" id="AUTHORIZE" value="<?php echo $wchat_config['value']['AUTHORIZE']; ?>">
<input type ="hidden" id="CALLBACK" value="<?php echo $wchat_config['value']['CALLBACK']; ?>">
<script>
function setConfigAjax(){
	var appkey = $("#APP_KEY").val();
	var appsecret = $("#APP_SECRET").val();
	...
	$.ajax({
		type:"post",
		url:"<?php echo __URL('ADMIN_MAIN/config/loginweixinconfig'); ?>",
		data:{
			'appkey':appkey,
			'appsecret':appsecret,
			'url':url,
