<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:41:"template/adminblue\System\moduleList.html";i:1522669943;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<table class="table-class">
	...
	<tr class="pid_0" style="height: 30px;">
		<td>
			...
			<a href="javascript:;" onclick="tab_switch(<?php echo $v1['module_id']; ?>)" class="tab_jia_<?php echo $v1['module_id']; ?>" style="display: block;">[+]</a>
			<a href="javascript:;" onclick="tab_switch(<?php echo $v1['module_id']; ?>)" class="tab_jian_<?php echo $v1['module_id']; ?>" style="display: none;">[-]</a>
			<?php endif; ?>
		</td>
		...
		<td style="text-align: center;">
			<input onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')" type="text" class="sort input-common input-common-sort" fieldid="<?php echo $v1['module_id']; ?>" fieldname="sort" value="<?php echo $v1['sort']; ?>" size="1">
		</td>
		<td style="text-align: center;">
		...
		<tr class="pid_<?php echo $v1['module_id']; ?>" style="height: 30px; display: none;">
			<td>
				...
				<a href="javascript:void(0)" onclick="tab_switch(<?php echo $v2['module_id']; ?>)" class="tab_jian_<?php echo $v2['module_id']; ?> tab_jian_<?php echo $v1['module_id']; ?>" style="display: block;">[-]</a>
				<a href="javascript:void(0)" onclick="tab_switch(<?php echo $v2['module_id']; ?>)" class="tab_jia_<?php echo $v2['module_id']; ?> tab_jia_<?php echo $v1['module_id']; ?>" style="display: none;">[+]</a>
				<?php endif; ?>
			</td>
			...
			<td style="text-align: center;">
				<input onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')" type="text" class="sort input-common input-common-sort" fieldid="<?php echo $v2['module_id']; ?>" fieldname="sort" value="<?php echo $v2['sort']; ?>" size="1">
			</td>
			<td style="text-align: center;">
			...
			<tr class="pid_<?php echo $v2['module_id']; ?> pid_<?php echo $v1['module_id']; ?>" style="height: 30px; display: none;">
				...
				<td style="text-align: center;">
					<input type="text" class="sort input-common input-common-sort" fieldid="<?php echo $v3['module_id']; ?>" fieldname="sort" value="<?php echo $v3['sort']; ?>" size="1">
				</td>
				<td style="text-align: center;">
				...
				<tr class="pid_<?php echo $v3['module_id']; ?> pid_<?php echo $v2['module_id']; ?> pid_<?php echo $v1['module_id']; ?>" style="height: 30px; display: none;">
					<td></td>
					<td style="text-align: center;">
						<input type="text" class="sort input-common input-common-sort" fieldid="<?php echo $v4['module_id']; ?>" fieldname="sort" value="<?php echo $v4['sort']; ?>" size="1">
					</td>
					<td>
						<span style="color: #ccc;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|——</span>
					...
					<tr class="pid_<?php echo $v4['module_id']; ?> pid_<?php echo $v3['module_id']; ?> pid_<?php echo $v2['module_id']; ?> pid_<?php echo $v1['module_id']; ?>" style="height: 30px; display: none;">
						<td></td>
						<td style="text-align: center;">
							<input type="text" class="sort input-common input-common-sort" fieldid="<?php echo $v5['module_id']; ?>" fieldname="sort" value="<?php echo $v5['sort']; ?>" size="1">
						</td>
						<td>
							<span style="color: #ccc;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|——</span>
