<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:46:"template/adminblue\Promotion\fullShipping.html";i:1522665946;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		...
		<dd>
			<p>
				<input  type="checkbox"  id="manebaoyouResult" class="checkbox" <?php if($info['is_open'] == 1): ?>checked="checked"<?php endif; ?>  
				/>
			</p>
		</dd>
	</dl>
	<dl>
		...
		<dd>
			<div>
				<input id="full_mail_money" class="input-mini input-common harf" type="number" min="0.01" step="0.01" value="<?php echo $info['full_mail_money']; ?>" /><em class="unit">元</em>
	...
	<dl>
		...
		<dd>
			<div>
				<span class="js-region-info region-info"><?php echo $no_mail_province; ?></span>
								...
								<div class="dcity clearfix">
									...
									<div class="ecity gcity">
										<span class="group-label">
											<i class="checkbox-common"><input id="first_region_<?php echo $k; ?>" data-first-index="<?php echo $k; ?>" value="<?php if(is_array($area['province_list']) || $area['province_list'] instanceof \think\Collection || $area['province_list'] instanceof \think\Paginator): if( count($area['province_list'])==0 ) : echo "" ;else: foreach($area['province_list'] as $key=>$province): ?><?php echo $province['province_id']; ?>,<?php endforeach; endif; else: echo "" ;endif; ?>" type="checkbox" /></i>
									...
									<div class="province-list">
										...
										<div class="ecity">
											<span class="gareas">
												...
												<i class="checkbox-common"><input data-second-parent-index="<?php echo $k; ?>" data-province-id="<?php echo $province['province_id']; ?>" id="second_region_<?php echo $k; ?>_<?php echo $province['province_id']; ?>" type="checkbox" data-province-name="<?php echo $province['province_name']; ?>" value="<?php echo $province['province_id']; ?>" /></i>
												...
												<div class="citys" id="citys_<?php echo $province['province_id']; ?>">
													<?php if(is_array($province['city_list']) || $province['city_list'] instanceof \think\Collection || $province['city_list'] instanceof \think\Paginator): if( count($province['city_list'])==0 ) : echo "" ;else: foreach($province['city_list'] as $third=>$city): ?>
														<span class="areas">
															<i class="checkbox-common"><input data-third-parent-index="<?php echo $k; ?>" data-province-id="<?php echo $province['province_id']; ?>" data-city-id="<?php echo $city['city_id']; ?>" value="<?php echo $city['city_id']; ?>" id="third_<?php echo $k; ?>_<?php echo $city['city_id']; ?>" type="checkbox" /></i>
...
<?php if($info['no_mail_province_id_array'] !=''): ?>
<input type="hidden" id="hidden_province_id_array" value="<?php echo $info['no_mail_province_id_array']; ?>" />
<?php else: ?>
<input type="hidden" id="hidden_province_id_array"/>
<?php endif; if($info['no_mail_city_id_array'] !=''): ?>
<input type="hidden" id="hidden_city_id_array" value="<?php echo $info['no_mail_city_id_array']; ?>" />
<?php else: ?>
...
function SavepointConfig(){
	...
	$.ajax({
		type:"post",
		url : "<?php echo __URL('ADMIN_MAIN/promotion/fullshipping'); ?>",
		data : {
			"is_open" : is_open,
