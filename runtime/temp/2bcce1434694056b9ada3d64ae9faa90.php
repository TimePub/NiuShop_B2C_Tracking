<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:44:"template/adminblue\Config\customservice.html";i:1521193266;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<!-- 					<?php if($warm_prompt_is_show == 'show'): ?>style="display:none;"<?php endif; ?> style="display:block;" -->
	...
	<p class="function-prompts">
		<ul>
			<li>当前客服仅适用于以下三种链接</li>
			<li>1.美洽
				<br/>链接地址：<a href="http://www.meiqia.com"  target="_brank">www.meiqia.com</a>
				使用教程：<a href="http://www.niushop.com.cn/document.html?class_id=20&dir_id=63&id=122" target="_blank">http://www.niushop.com.cn/document.html?class_id=20&dir_id=63&id=122</a>
			</li>
			<li>2.KF5
				<br/>链接地址：<a href="http://www.kf5.com" target="_brank">www.kf5.com</a>
				使用教程：<a href="http://www.niushop.com.cn/document.html?class_id=20&dir_id=63&id=123" target="_blank">http://www.niushop.com.cn/document.html?class_id=20&dir_id=63&id=123</a></li>
			<li>3.QQ(qq客服需填写当前客服的qq号码)<br/><br/></li>
		</ul>
	</p>
</p>
								</div>
...
<input type="hidden" id="withdraw_id" value="<?php echo $list['id']; ?>">
<div class="set-style">
	<dl>
		<dt>美洽客服链接：</dt>
		<dd>
			<input id="meiqia_service_addr" type="text" value="<?php echo $list['value']['meiqia_service_addr']; ?>" class="input-common" />
			<input type="radio" name="service_addr" value="1" <?php if($list['value']['checked_num'] == 1): ?>checked="checked"<?php endif; ?>/>
			<?php if($list['value']['checked_num'] == 1): ?>
			<td style="text-align: center;line-height:59px;">
				<a href="javascript:;" class="pay-start" status =1 onclick="set_status(this)">
					<img src="ADMIN_IMG/checked.png" alt="" width="18"/>
				</a>
			</td>
			<?php else: ?>
			<td style="text-align: center;line-height:59px;">
				<a href="javascript:;" class="pay-close" status =0 onclick="set_status(this)">
	...
	<dl>
		<dt>kf5客服链接：</dt>
		<dd>
			<input id="kf_service_addr" type="text" value="<?php echo $list['value']['kf_service_addr']; ?>" class="input-common" />
			<input type="radio" name="service_addr" value="2" <?php if($list['value']['checked_num'] == 2): ?>checked="checked"<?php endif; ?>/>
			<?php if($list['value']['checked_num'] == 2): ?>
			<td style="text-align: center;line-height:59px;">
				<a href="javascript:;" class="pay-start" status =1 onclick="set_status(this)">
					<img src="ADMIN_IMG/checked.png" alt="" width="18"/>
				</a>
	...
	<dl>
		<dt>QQ客服：</dt>
		<dd>
			<input id="qq_service_addr" type="text" value="<?php echo $list['value']['qq_service_addr']; ?>" class="input-common" />
			<input type="radio" name="service_addr" value="3" <?php if($list['value']['checked_num'] == 3): ?>checked="checked"<?php endif; ?>/>
			<?php if($list['value']['checked_num'] == 3): ?>
			<td style="text-align: center;line-height:59px;">
				<a href="javascript:;" class="pay-start" status =1 onclick="set_status(this)">
					<img src="ADMIN_IMG/checked.png" alt="" width="18"/>
				</a>
	...
	<dl>
		<dt></dt>
		<dd>
			<button class="btn-common btn-big" onclick="setMemberwithdrawAjax();">保存</button>
		</dd>
	</dl>
	<!-- <dl>
		<dt>提现手续费比例:</dt>
		<dd>
			<input id="poundage" type="number" min="0.00" step="0.01"  value="<?php echo $list['value']['withdraw_poundage']; ?>" />&nbsp;%<span class="withdraw_rule" id="verification_poundage">提现手续费不能为空</span>
...
<!-- 				<input type="hidden" id="is_open" value="<?php echo $list['is_use']; ?>"> -->
<!-- 			</div> -->
...
function set_status(event){
	$('.set-style').find('img').attr('src', 'ADMIN_IMG/un_checked.png');
	$(event).find('img').attr('src', 'ADMIN_IMG/checked.png');
	$("input[type='radio']").prop('checked',false);
	$(event).parents('dd').find("input[type='radio']").prop('checked',true);
...
function setMemberwithdrawAjax() {
	...
	var meiqia_service_addr = $("#meiqia_service_addr").val();
	var kf_service_addr = $("#kf_service_addr").val();
	var qq_service_addr = $("#qq_service_addr").val();
	var checked_num = $('input[name="service_addr"]:checked').val();
		$.ajax({
			type : "post",
			url : "<?php echo __URL('ADMIN_MAIN/config/customservice'); ?>",
			data : {
				'meiqia_service_addr' : meiqia_service_addr,
				'kf_service_addr' : kf_service_addr,
				'qq_service_addr' : qq_service_addr,
