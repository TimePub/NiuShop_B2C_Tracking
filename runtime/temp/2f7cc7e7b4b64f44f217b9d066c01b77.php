<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:57:"template/adminblue\Config\distributionAreaManagement.html";i:1522665946;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:44:"template/adminblue\Express\expressTitle.html";i:1522053049;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
	...
	<div class="mod-table-head">
		...
		<table class="table">
			...
			<tbody>
				...
				<tr align="left">
					<th class="province">
						<label for="province_<?php echo $vo['province_id']; ?>">
							<i class="checkbox-common">
							<input type="checkbox" id="province_<?php echo $vo['province_id']; ?>" value="<?php echo $vo['province_id']; ?>" name="province_id_<?php echo $vo['province_id']; ?>" onclick="provinceClick(<?php echo $vo['province_id']; ?>,this);" <?php if(!(empty($provinces) || (($provinces instanceof \think\Collection || $provinces instanceof \think\Paginator ) && $provinces->isEmpty()))): if(is_array($provinces) || $provinces instanceof \think\Collection || $provinces instanceof \think\Paginator): if( count($provinces)==0 ) : echo "" ;else: foreach($provinces as $key=>$po): if($vo['province_id'] == $po): ?>checked="checked"<?php endif; endforeach; endif; else: echo "" ;endif; endif; ?>>
							</i>
							<span><?php echo $vo['province_name']; ?></span>
						</label>
					</th>
					<td class="city">
...
function save(){
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/config/addorupdatedistributionareaajax'); ?>",
		data : {
		...
		success : function(data){
			if(data['code']>0){
				...
				location.href = "<?php echo __URL('ADMIN_MAIN/config/distributionareamanagement'); ?>";
			}
		}
	})
}
