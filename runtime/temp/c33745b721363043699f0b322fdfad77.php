<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:43:"template/adminblue\Config\searchConfig.html";i:1521172363;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		...
		<dd>
			...
			<textarea rows="2" id="keywords" class="textarea-common" maxlength="50"><?php echo $hot_keywords; ?></textarea>
...
function setConfigAjax(){
	...
	$.ajax({
		type:"post",
		url:"<?php echo __URL('ADMIN_MAIN/config/hotsearchconfig'); ?>",
...
<div class="set-style">
	<dl>
		<dt>默认搜索：</dt>
		<dd>
			<input id="default_keywords" type="text" value="<?php echo $default_keywords; ?>" class="input-common" />
...
function setConfigAjax(){
	...
	$.ajax({
		type:"post",
		url:"<?php echo __URL('ADMIN_MAIN/config/defaultsearchconfig'); ?>",
