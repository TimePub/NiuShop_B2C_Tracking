<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:40:"template/adminblue\Config\webConfig.html";i:1522406836;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	...
	<dl>
		...
		<dd>
			<p>
				<input id="key_words" type="text" value="<?php echo $website['key_words']; ?>" class="input-common long" />
			</p>
	...
	<dl>
		<dt>网站描述：</dt>
		<dd>
			<textarea name="store_zy" rows="2" id="web_desc" class="textarea-common" ><?php echo $website['web_desc']; ?></textarea>
	...
	<dl>
		...
		<dd>
			<div class="upload-btn-common">
				...
				<input type="text" id="text_logo" class="input-common" readonly="readonly" value="<?php if($website['logo']): ?><?php echo $website['logo']; endif; ?>" />
				<em>上传</em>
				
				<img id="preview_logo" src="__STATIC__/blue/img/upload-common-select.png" <?php if($website['logo']): ?>data-src="<?php echo __IMG($website['logo']); ?>"<?php endif; ?> data-html="true" data-container="body" data-placement="top" data-trigger="manual"/>
	...
	<dl>
		...
		<dd>
			...
			<div class="upload-btn-common">
				<div>
					<input class="input-file" name="file_upload" id="uploadImgwechat_share_logo" type="file" onchange="imgUpload(this);" title="上传">
					<input type="hidden" id="wechat_share_logo" value="<?php echo $website['web_wechat_share_logo']; ?>" />
				</div>
				<input type="text" id="text_wechat_share_logo" class="input-common" readonly="readonly" value="<?php if($website['web_wechat_share_logo']): ?><?php echo $website['web_wechat_share_logo']; endif; ?>" />
				<em>上传</em>
				
				<img id="preview_wechat_share_logo" src="__STATIC__/blue/img/upload-common-select.png" <?php if($website['web_wechat_share_logo']): ?>data-src="<?php echo __IMG($website['web_wechat_share_logo']); ?>"<?php endif; ?> data-html="true" data-container="body" data-placement="top" data-trigger="manual"/>

			</div>
			<p class="hint">
				<span>建议使用<i class="important-note">宽80</i>像素-<i class="important-note">高80</i>像素内的正方形图片</span>
			</p>
		</dd>
	</dl>
	<dl>
		...
		<dd>
			<div class="upload-btn-common">
				<input type="text" id="text_qrcode_path" class="input-common" readonly="readonly" value="<?php echo $qrcode_path; ?>">
				<img id="preview_qrcode_path" style="margin:0;" src="__STATIC__/blue/img/upload-common-select.png" data-src="<?php echo __IMG($qrcode_path); ?>" data-html="true" data-container="body" data-placement="top" data-trigger="manual"/>
			</div>
		</dd>
	</dl>
	...
	<dl>
		...
		<dd>
			...
			<div class="upload-btn-common">
				<div>
					<input class="input-file" name="file_upload" id="uploadImgweb_qrcode" type="file" onchange="imgUpload(this);" title="上传">
					<input type="hidden" id="web_qrcode" value="<?php echo $website['web_wechat_share_logo']; ?>" />
				</div>
				<input type="text" id="text_web_qrcode" class="input-common" readonly="readonly" value="<?php if($website['web_qrcode']): ?><?php echo $website['web_qrcode']; endif; ?>" />
				<em>上传</em>
				
				<img id="preview_web_qrcode" src="__STATIC__/blue/img/upload-common-select.png" <?php if($website['web_qrcode']): ?>data-src="<?php echo __IMG($website['web_qrcode']); ?>"<?php endif; ?> data-html="true" data-container="body" data-placement="top" data-trigger="manual"/>

			</div>
			
			<p class="hint">
				<span>建议使用<i class="important-note">宽100</i>像素-<i class="important-note">高100</i>像素内的<i class="important-note">GIF</i>或<i class="important-note">PNG</i>透明图片</span>
			</p>
	...
	<dl>
		<dt>联系地址：</dt>
		<dd>
			<input id="web_address" type="text" value="<?php echo $website['web_address']; ?>" class="input-common long" />
		</dd>
	</dl>
	<h4>备案与统计设置</h4>
	<dl>
	...
	<dl>
		<dt>商城第三方统计代码：</dt>
		<dd>
			<textarea name="store_zy" rows="2" id="third_count" class="textarea-common"><?php echo $website['third_count']; ?></textarea>
...
// 			'web_style_pc' : web_style_pc,
		...
		success : function(data) {
			if (data["code"] > 0) {
				...
				window.location.href = "<?php echo __URL('ADMIN_MAIN/config/webconfig'); ?>";
			} else {
				showTip(res.message,"error");
			}
		}
