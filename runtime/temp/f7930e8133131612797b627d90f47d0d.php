<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:49:"template/adminblue\Promotion\getDiscountList.html";i:1522725456;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<table class="mytable">
	<tr>
		<th width="20%" style="text-align: left;">
			...
			<button class="btn-common btn-small" onclick="location.href='<?php echo __URL('ADMIN_MAIN/promotion/adddiscount'); ?>';" style="margin:0 5px 0 0 !important;">添加限时折扣</button>
		</th>
		<th width="10%">
...
function LoadingInfo(page_index) {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/promotion/getdiscountlist'); ?>",
		data : {
...
function delDiscount(discount_id){
	$.ajax({
		type:"post",
		url : "<?php echo __URL('ADMIN_MAIN/promotion/deldiscount'); ?>",
...
function closeDiscount(discount_id){
	$.ajax({
		type:"post",
		url : "<?php echo __URL('ADMIN_MAIN/promotion/closediscount'); ?>",
...
function discountInfo(discount_id){
	...
	$.ajax({
		type:"get",
		url : "<?php echo __URL('ADMIN_MAIN/promotion/getdiscountdetail'); ?>",
		data : { "discount_id" : discount_id },
		success : function(data) {
