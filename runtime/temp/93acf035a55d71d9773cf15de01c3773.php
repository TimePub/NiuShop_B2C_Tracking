<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:41:"template/adminblue\Config\pcTemplate.html";i:1521253619;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<article class="pc-template">
	...
	<?php if(is_array($template_list) || $template_list instanceof \think\Collection || $template_list instanceof \think\Paginator): if( count($template_list)==0 ) : echo "" ;else: foreach($template_list as $k=>$template): if($template['folder'] == $use_template): ?>
	<div class="block-title">当前使用模板</div>
	<div class="template-list js-curr-use">
		<ul>
			<li style="background-color: <?php echo $template['bgcolor']; ?>">
				<h4><?php echo $template['theme']; ?></h4>
				<p><?php echo $template['introduce']; ?></p>
				<div class="template-thumbnail">
					<img src="__TEMP__/shop/<?php echo $template['folder']; ?>/<?php echo $template['preview']; ?>" alt="缩略图">
				</div>
			</li>
		</ul>
	</div>
	...
	<div class="template-list">
		<ul>
			...
			<li style="background-color: <?php echo $template['bgcolor']; ?>" <?php if($k>0 &&($k+1)%5==0): ?>style="margin-right:0;"<?php endif; ?> data-bgcolor="<?php echo $template['bgcolor']; ?>">
				<div class="mask-layer">
					<button class="btn-common btn-big" data-folder="<?php echo $template['folder']; ?>">使用该模板</button>
				</div>
				<h4><?php echo $template['theme']; ?></h4>
				<p><?php echo $template['introduce']; ?></p>
				<div class="template-thumbnail">
