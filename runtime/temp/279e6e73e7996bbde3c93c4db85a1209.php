...
#btnBut{width:100px;margin:10px 15px;}
...
<strong>提示：</strong>设置分享内容，设置方法如下：<br>
...
<div class="main share">
		...
		<dl>
			...
			<dd>
				<p class="price" style="margin:5px 0;">
					...
					<input class="input-common w60 middle" type="text" value="<?php echo $config['qrcode_param_1']; ?>" placeholder="请输入分享标题" style="display: none;" id="Qrcode_param_1">
				</p>
				<p class="advertisiment">
					<span class="text" id="qrcode_two" style="display: block;"><?php echo $config['qrcode_param_2']; ?></span>
					<input class="input-medium input-common middle" type="text" value="<?php echo $config['qrcode_param_2']; ?>" style="display: none;" id="Qrcode_param_2">
				</p>
		...
		<dl>
			...
			<dd style="padding-left:10px;">
				<p class="price">
					...
					<input class="w60 input-common middle" type="text" value="<?php echo $config['goods_param_1']; ?>" placeholder="价格标题" style="display: none;" id="PriceDesc">
					<span class="number"><!-- ￥0.00 --></span>
				</p>
				<p class="advertisiment">
					<span class="text" id="descspan" style="display: block;"><?php echo $config['goods_param_2']; ?></span>
					<input class="input-medium input-common middle" type="text" value="<?php echo $config['goods_param_2']; ?>" style="display: none;" id="ProductDesc">
				</p>
				<p class="hot"><span>收藏热度：</span><span class="star">★★★★★</span></p>
			</dd>
		</dl>
	...
	<div class="store">
		...
		<h4 class="store-title">
			...
			<input type="text" class="input-medium input-common middle" value="<?php echo $config['shop_param_1']; ?>" placeholder="请输入欢迎语" style="display: none;">
		...
		<dl>
			...
			<dd>
				<p class="price">
					...
					<input id="txtOpenRemark" class="input-medium input-common middle" type="text" value="<?php echo $config['shop_param_2']; ?>" placeholder="请输入分享标题" style="display: none;">
				</p>
				<p class="more">
					<span class="text" id="openremarkspan2" style="display: block;"><?php echo $config['shop_param_3']; ?></span>
					<input class="input-medium input-common middle" type="text" value="<?php echo $config['shop_param_3']; ?>" style="display: none;">
				</p>
				<p class="hot"><span>收藏热度：</span><span class="star">★★★★★</span></p>
			</dd>
		</dl>
