<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:49:"template/adminblue\Dbdatabase\importDataList.html";i:1522669943;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="mod-table">
	<div class="mod-table-head">
		<table class="table-class ">
			...
			<thead>
				<tr align="center">
					<th  style="text-align: center;"><i class="checkbox-common"><input type="checkbox" onclick="CheckAll(this)"></i></th>
...
function getImportDatalist(page_index) {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/dbdatabase/importdatalist'); ?>",
...
function deleteDataBase(time){
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/dbdatabase/deleteDataBase'); ?>",
		data : {"time":time},
		dataType : "json",
		success : function(data) {
			if (data.status){
...
function importData(time, part, start){
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/dbdatabase/importData'); ?>",
