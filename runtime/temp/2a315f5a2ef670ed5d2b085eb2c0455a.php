<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:44:"template/adminblue\Config\fixedtemplate.html";i:1521253619;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<!-- <dl>
		...
		<dd class="borderclass">
			<textarea rows="2" id="notice_message" class="textarea w400 input-common" maxlength="50"><?php echo $info['notice_message']; ?></textarea>
		</dd>
	</dl>
	<dl>
		<dt>是否启用用户通知：</dt>
	...
	<dl>
		...
		<dd class="borderclass classified-display-mode">
				<label class="radio inline normal">
					<i class="radio-common <?php if($classified_display_mode==1): ?>selected<?php endif; ?>"><input type="radio" name="input-classified-display-mode" value="1"<?php if($classified_display_mode==1): ?> checked="checked"<?php endif; ?>/></i>
					<span>缩略图模式</span>
				</label>
				<label class="radio inline normal">
					<i class="radio-common <?php if($classified_display_mode==2): ?>selected<?php endif; ?>"><input type="radio" name="input-classified-display-mode" value="2"<?php if($classified_display_mode==2): ?> checked="checked"<?php endif; ?>/></i>
					<span>列表模式</span>
				</label>
		</dd>
	</dl>
...
function setConfigAjax(){
	...
	$.ajax({
		type:"post",
		url:"<?php echo __URL('ADMIN_MAIN/config/updateWapBasicInformation'); ?>",
		data:{ 'notice_message' : notice_message, 'is_enable' : is_enable,'classified_display_mode' : classified_display_mode },
		success:function (data) {
			if (data["code"] > 0) {
				showTip(data["message"],"success");
				location.href = "<?php echo __URL('ADMIN_MAIN/config/fixedtemplate'); ?>";
			}else{
