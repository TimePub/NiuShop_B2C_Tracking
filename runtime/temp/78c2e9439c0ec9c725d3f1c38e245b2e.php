<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:44:"template/adminblue\Config\paymentConfig.html";i:1521883320;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<table class="table-class">
	...
	<tbody>
		<?php if(is_array($pay_list) || $pay_list instanceof \think\Collection || $pay_list instanceof \think\Paginator): $i = 0; $__LIST__ = $pay_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pay_obj): $mod = ($i % 2 );++$i;?>
		<tr>
			<td>
				<div class="table-logo"><img src="__ROOT__/<?php echo $pay_obj['logo']; ?>"/></div>
				<span class="table-pay"><?php echo $pay_obj['pay_name']; ?></span><br/>
				<span class="table-desc"><?php echo $pay_obj['desc']; ?></span> 
			</td>
			<?php if($pay_obj['is_use'] == 1): ?>
			<td style="text-align: center;line-height:59px;"><a href="javascript:;" class="pay-start" status =1 onclick="set_status('<?php echo $pay_obj['key']; ?>', this)"><img src="ADMIN_IMG/checked.png" alt="" width="18"/></a></td>
			<?php else: ?>
			<td style="text-align: center;line-height:59px;"><a href="javascript:;" class="pay-close" status =0 onclick="set_status('<?php echo $pay_obj['key']; ?>', this)"><img src="ADMIN_IMG/un_checked.png" alt="" width="18"/></a></td>
			<?php endif; ?>
			<td style="text-align: center;line-height:59px;">
			<?php if($pay_obj['key'] == 'WPAY'): ?>
				<a href="<?php echo __URL('ADMIN_MAIN/config/payconfig','type=wchat'); ?>">配置</a>
			<?php elseif($pay_obj['key'] == 'ALIPAY'): ?>
				<a href="<?php echo __URL('ADMIN_MAIN/config/payaliconfig'); ?>">配置</a>
			<?php else: ?>
				<a href="<?php echo __URL('ADMIN_MAIN/config/unionpayconfig'); ?>">配置</a>
			<?php endif; ?>
			</td>
		</tr>
		<?php endforeach; endif; else: echo "" ;endif; ?>
