<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:47:"template/adminblue\Shop\pickupPointFreight.html";i:1522476869;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:44:"template/adminblue\Express\expressTitle.html";i:1522053049;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		...
		<h4>门店运费管理</h4>
			<div class="set-style">
				<dl>
					<dt>门店运费：</dt>
					<dd>
						<input id="pickup_freight" class="input-common harf" type="number" min="0" placeholder="0" onkeyup="freight_change(this);" value="<?php echo $config->pickup_freight; ?>" /><em class="unit">元</em>
						<p class="hint">如果会员选择配送方式是门店自提对应运费</p>
					</dd>
				</dl>
				<dl>
					<dt>满X免运费：</dt>
					<dd><input id="manjian_freight" class="input-common harf" type="number" min="0" placeholder="0" onkeyup="freight_change(this);" value="<?php echo $config->manjian_freight; ?>" /><em class="unit">元</em></dd>
				</dl>
				<dl>
					<dt>是否启用：</dt>
					<dd>
						<p>
							<input id="is_enable" type="checkbox" class="checkbox" <?php if($config->is_enable==1): ?> checked="checked"<?php endif; ?>/>
						</p>
					</dd>
				</dl>
				<dl>
...
<script>
	...
	function setConfigAjax(){
		...
		$.ajax({
			type:"post",
			url:"<?php echo __URL('ADMIN_MAIN/shop/pickupPointFreightAjax'); ?>",
			data:{
