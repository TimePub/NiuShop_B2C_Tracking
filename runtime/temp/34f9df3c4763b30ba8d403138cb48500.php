<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:40:"template/adminblue\Config\seoConfig.html";i:1522406836;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		<dt>标题附加字：</dt>
		<dd>
			<input id="title" type="text" value="<?php echo $info['seo_title']; ?>" class="input-common long" />
	...
	<dl>
		<dt>商城关键词：</dt>
		<dd>
			<input id="meta" type="text"  value="<?php echo $info['seo_meta']; ?>" class="input-common long" />
			<p class="hint">Keywords项出现在页面头部的标签中，用于记录本页面的关键字，多个关键字请用<i class="important-note">英文“,”</i>分隔</p>
		</dd>
	</dl>
	<dl>
		<dt>关键词描述：</dt>
		<dd>
			<input id="desc" type="text" value="<?php echo $info['seo_desc']; ?>" class="input-common long" />
	...
	<dl>
		<dt>其他页头信息：</dt>
		<dd>
			<textarea id="other" class="textarea-common" maxlength="50"><?php echo $info['seo_other']; ?></textarea>
...
function setConfigAjax(){
	...
	$.ajax({
		type:"post",
		url : "<?php echo __URL('ADMIN_MAIN/config/seoconfig'); ?>",
		data : {
			"seo_title" : title,
			"seo_meta" : meta,
			"seo_desc" : desc,
