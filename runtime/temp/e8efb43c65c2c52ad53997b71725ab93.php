<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:45:"template/adminblue\Promotion\pointConfig.html";i:1522728848;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		<dt>积分抵现比率：</dt>
		<dd>
			<input id="integrat_money" class="input-mini input-common harf" type="number" min="0.01" step="0.01" value="<?php echo $pointconfiginfo['convert_rate']; ?>"
			/><em class="unit">元</em>
	...
	<dl>
		...
		<dd>
			<p>
				<input id="is_open" type="checkbox"  class="checkbox"   <?php if($pointconfiginfo['is_open'] == 1): ?>checked<?php endif; ?>/>
			</p>
		...
		<dl>
		<dt>积分说明：</dt>
		<dd><textarea id="integrat_description" class="textarea-common" ><?php echo $pointconfiginfo['desc']; ?></textarea></dd>
	</dl>
	<dl>
		<dt></dt>
		<dd>
