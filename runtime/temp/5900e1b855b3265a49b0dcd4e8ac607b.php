<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:47:"template/adminblue\Config\registerAndVisit.html";i:1523238980;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		...
		<dd>
			<div class="controls">
				<p>
					<input id="is_register" type="checkbox" <?php if($register_and_visit['is_register'] == 1): ?>checked<?php endif; ?> class="checkbox"/>
				</p>
			</div>
	...
	<dl>
		...
		<dd>
			...
			<p class="hint">如开启邮箱和手机注册，请在<a href="<?php echo __URL('ADMIN_MAIN/config/notifyindex'); ?>" target="_blank">通知系统</a>功能中进行邮箱与短信通知配置，游客在注册时通过验证后方能注册成功</p>
		</dd>
	</dl>
	<dl>
		<dt>后台验证码是否开启：</dt>
		<dd>
			<input id="adminCode" type="checkbox" class="checkbox" <?php if($code_config['admin']=='1'): ?>checked="checked"<?php endif; ?>/>
		</dd>
	</dl>
	<dl>
		<dt>商城验证码是否开启：</dt>
		<dd>
			<input id="pcCode" type="checkbox" class="checkbox" <?php if($code_config['pc']=='1'): ?>checked="checked"<?php endif; ?>/>
		</dd>
	</dl>
	<dl>
		<dt>用户名保留关键字：</dt>
		<dd>
			...
			<textarea rows="2" id="name_keyword" class="textarea-common" maxlength="300"><?php echo $register_and_visit["name_keyword"]; ?></textarea>
	...
	<dl>
		<dt>密码最小长度：</dt>
		<dd>
			<input id="pwd_len" type="number" min="0" step="1" value="<?php echo $register_and_visit['pwd_len']; ?>" class="input-common harf"/>
	...
	$.ajax({
		...
		success : function(data){
			if(data['code'] > 0){
				...
				window.location.href = "<?php echo __URL('ADMIN_MAIN/config/registerandvisit'); ?>";
			}else{
