<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:50:"template/adminblue\Wchat\weixinQrcodeTemplate.html";i:1521276033;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
.check div:hover{background: #126AE4;border:1px solid #126AE4;}
...
<div id="pictureIndex" class="ncsc-picture-folder">
	<div class="ncsc-album">
		...
		<?php endif; if($info['is_check'] == 1): if(file_exists("$info[template_url]")): ?>
				<img src="<?php echo __IMG($info['template_url']); ?>" style="border:1px solid #00C0FF;"/>
				<?php else: ?>
				...
				<img src="<?php echo __IMG($info['template_url']); ?>" style="border:1px solid #eee;"/>
				<?php else: ?>
	...
	$.ajax({
		...
		success : function(data) {
			if(data['code'] > 0){
				...
				location.href = "<?php echo __URL('ADMIN_MAIN/wchat/weixinqrcodetemplate'); ?>";
			}else{
...
function load_url(){
	window.location.href="<?php echo __URL('ADMIN_MAIN/wchat/qrcode'); ?>";
}

function modifyWeixinQrcode(id){
	window.location.href=__URL('ADMIN_MAIN/wchat/qrcode?id=' + id);
}
</script>
