...
function LoadingInfo(page_index) {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/auth/authLog'); ?>",
	...
	$( "#dialog" ).dialog({
		buttons: {
			"确定": function() {
				$(this).dialog('close');
				$.ajax({
				url : "<?php echo __URL('ADMIN_MAIN/auth/deleteLog'); ?>",
				data : {"id" : id.toString() },
				type : "post",
				dataType : "json",
				success : function(data) {
