<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:42:"template/adminblue\Wchat\appletConfig.html";i:1521276033;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<h4>小程序开发者设置<span class="muted">（必填）</span></h4>

	<dl>
		<dt>APPID：</dt>
		<dd>
			<input class="span2 input-common" id="appid" placeholder="AppID" value="<?php echo $applet_config['appid']; ?>" type="text" style="width:270px;">
	...
	<dl>
		<dt>APP密钥：</dt>
		<dd>
			<input class="span2 input-common" id="appsecret" type="text" placeholder="Appsecret" value="<?php echo $applet_config['appsecret']; ?>" style="width:270px;">
			<span class="help-inline" id="appsecreterror" style="color:red;"></span>
			<p class="hint">
				AppID以及Appsecret来自于您申请开发接口时提供的账号和密码，且公众号为已认证服务号
			</p>
		</dd>
	</dl>
    ...
    <dl>
		...
		<dd>
			...
			<p class="text-success">
				<span class="muted">域名1：</span>https://<?php echo $url; ?>
			</p>
			<p>业务域名设置完毕！</p>
		</dd>
	</dl>
    <dl>
		...
		<dd>
			...
			<p class="text-success">
				<span class="muted">request合法域名：</span>https://<?php echo $url; ?>
			</p>
			<p class="text-success">
				<span class="muted">uploadFile合法域名：</span>https://<?php echo $url; ?>
			</p>
			<p class="text-success">
				<span class="muted">downloadFile合法域名：</span>https://<?php echo $url; ?>
			</p>
			<p>服务器域名设置完毕！</p>
		</dd>
	</dl>    
...
<div style="padding:30px;display:none">
	<div class="smallTitle mt30">
		<span class="text">绑定微信小程序开发者账号</span><span class="muted">（必填）</span>
	</div>
	<div class="binding">
	...
	<div class="smallTitle mt30">
		<span class="text">设置业务域名</span><span class="muted"></span>
	</div>
	...
	<div class="smallTitle mt30">
		<span class="text">设置服务器域名</span><span class="muted"></span>
	</div>
...
function save() {
	...
	if(appid.length < 100 && appsecret.length < 100){
		$.ajax({
			type : "post",
			url : "<?php echo __URL('ADMIN_MAIN/wchat/setInstanceAppletConfig'); ?>",
