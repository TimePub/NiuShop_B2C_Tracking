<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:40:"template/adminblue\Config\payConfig.html";i:1523962710;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		<dt>应用ID：</dt>
		<dd>
			<input id="APP_KEY" type="text" value="<?php echo $config['value']['appid']; ?>" class="input-common long" />
	...
	<dl>
		<dt>应用密钥：</dt>
		<dd>
			<input id="APP_SECRET" type="text" value="<?php echo $config['value']['appkey']; ?>" class="input-common long" />
		...
		<dt>支付专用签名串：</dt>
		<dd>
			<input id="paySignKey" type="text" value="<?php echo $config['value']['mch_key']; ?>" class="input-common long" />
	...
	<dl>
		<dt>微信支付商户号：</dt>
		<dd>
			<input id="MCHID" type="text" value="<?php echo $config['value']['mch_id']; ?>" class="input-common long" />
			<p class="hint"><i class="important-note">[MCHID]</i>微信支付商户号</p>
		</dd>
	</dl>
	<dl>
		<dt>支付授权目录：</dt>
		<dd><span class="text" style="background-color: white; border: none;min-width: 500px;display: inline-block;font-size: 13px;cursor: pointer;color:#468847;" id="empowerUrl" value=""><?php echo $root_url; ?></span></dd>
	</dl>
	...
	<dl>
		...
		<dd>
			...
			<?php if($original_road_refund_setting_info['apiclient_cert']): ?> value="<?php echo $original_road_refund_setting_info['apiclient_cert']; ?>"<?php endif; ?>>
		</dd>
	</dl>
	...
	<dl>
		...
		<dd>
			...
			<?php if($original_road_refund_setting_info['apiclient_key']): ?> value="<?php echo $original_road_refund_setting_info['apiclient_key']; ?>"<?php endif; ?>>
		</dd>
	</dl>
	<dl>
		<dt>是否启用支付：</dt>
		<dd>
			<p>
				<input id="is_use" type="checkbox" class="checkbox" <?php if($config['is_use']==1): ?> checked="checked"<?php endif; ?>/>
			</p>
		</dd>
	</dl>
	<!-- 原路退款设置 开始-->
	...
	<dl>
		...
		<dd>
			...
			<?php if($original_road_refund_setting_info['is_use']): ?>checked="checked"<?php endif; ?>/></p>
	...
	<dl style="display:none">
		...
		<dd>
			...
			<?php if($transfer_accounts_setting_info['is_use']): ?>checked="checked"<?php endif; ?>/></p>
			<p class="hint">需要配置微信支付同时配置好apiclient_cert和apiclient_key的绝对路径才可以进行后续操作</p>
		</dd>
	</dl>
...
function setConfigAjax(){
	...
	$.ajax({
		type:"post",
		url:"<?php echo __URL('ADMIN_MAIN/config/wchatconfig'); ?>",
		data:{
			'appkey':appkey,
			'appsecret':appsecret,
