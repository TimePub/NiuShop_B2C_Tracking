<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:42:"template/adminblue\System\shopAdvList.html";i:1522727994;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
function LoadingInfo(page_index) {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/system/shopadvlist'); ?>",
		data : {
...
function updateAdvSort(my){
	...
	$.ajax({
		type:"post",
		url:"<?php echo __URL('ADMIN_MAIN/System/modifyAdvSort'); ?>",
	...
	$( "#dialog" ).dialog({
		buttons: {
			"确定": function() {
				...
				$.ajax({
					type : "post",
					url : "<?php echo __URL('ADMIN_MAIN/system/delshopadv'); ?>",
					data : { "adv_id" : adv_id },
					success : function(data) {
						if(data["code"] > 0 ){
							showTip(data["message"],'success');
							location.href = __URL('ADMIN_MAIN/system/shopadvlist?ap_id=<?php echo $ap_id; ?>');
						}else{
							showTip(data["message"],'error');
						}
					}
