<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:52:"template/adminblue\Config\wapCustomTemplateList.html";i:1522739314;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	...
	<dl>
		<dt >是否开启自定义模板：</dt>
		<dd>
			<input type="checkbox" class="checkbox js-status" <?php if($is_enable == 1): ?>checked="checked"<?php endif; ?> />
		</dd>
	</dl>
	<h4>模版设置</h4>
</div>
	...
	<tbody>
		<tr>
			<td style="text-align: left;">
				...
				<button class="btn-common" onclick="location.href='<?php echo __URL('ADMIN_MAIN/config/wapCustomTemplateEdit'); ?>';" style="margin:0 !important;">添加模板页面</button>
			</td>
			<td>
...
function LoadingInfo(page_index) {
	$.ajax({
		...
		url : "<?php echo __URL('ADMIN_MAIN/config/wapCustomTemplateList'); ?>",
				...
				for(var i=0;i<data['data'].length;i++){
					...
					html += '<tr>';
						...
						html += '<td align="center">';
							html += '<a href=\'<?php echo __URL("ADMIN_MAIN/config/wapCustomTemplateEdit?id=' + curr.id + '"); ?>\'>编辑</a>';
	...
	$( "#dialog" ).dialog({
		buttons: {
			"确定": function() {
				$.ajax({
					type : "post",
					url : "<?php echo __URL('ADMIN_MAIN/config/deleteWapCustomTemplateById'); ?>",
					data : { "id" : id.toString() },
					success : function(data) {
						if(data["code"] > 0 ){
...
function setDefaultCustomTemplate(id){
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/config/setDefaultWapCustomTemplate'); ?>",
		data : { "id" : id },
...
$(".js-status").click(function(){
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/config/setIsEnableWapCustomTemplate'); ?>",
