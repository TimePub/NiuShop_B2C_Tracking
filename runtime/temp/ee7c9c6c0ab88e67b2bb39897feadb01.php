<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:43:"template/adminblue\Order\returnSetting.html";i:1522413022;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:44:"template/adminblue\Express\expressTitle.html";i:1522053049;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		...
		<h4>商家地址</h4>
			<div class="set-style">
				<dl>
					...
					<dd>
						<p><input id="address" type="text" value="<?php echo $info['shop_address']; ?>" class="input-common long"></p>
				...
				<dl>
					...
					<dd>
						<p><input id="receive" type="text" value="<?php echo $info['seller_name']; ?>" class="input-common" maxlength="15"></p>
				...
				<dl>
					...
					<dd>
						<p><input id="phone" type="text" value="<?php echo $info['seller_mobile']; ?>" class="input-common" onkeyup="checkMobile(this)" maxlength="26"></p>
				...
				<dl>
					<dt>邮编：</dt>
					<dd>
						<p><input id="zip" type="text" value="<?php echo $info['seller_zipcode']; ?>" class="input-common" maxlength="6" 
...
function addReturnAjax() {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/order/returnsetting'); ?>",
		data : {
			'address' : address,
			'real_name' : receive,
			'mobile' : phone,
