<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:48:"template/adminblue\Games\promotionGamesList.html";i:1522723199;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<table class="mytable">
	<tr>
		<th width="20%" style="text-align:left;"><button class="btn-common" onclick="location.href='<?php echo __URL('ADMIN_MAIN/promotion/promotionGameTypeList'); ?>';" style="margin:0 5px 0 0 !important;">添加活动</button></th>
		<th width="10%">
...
function LoadingInfo(page_index) {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/promotion/promotionGamesList'); ?>",
		data : {
	...
	$("#dialog").dialog({
		buttons: {
			"确定": function() {
				$.ajax({
					type:"post",
					url : "<?php echo __URL('ADMIN_MAIN/promotion/delPromotionGame'); ?>",
					data : { "game_id" : game_id},
					dataType : "json",
					success : function(data) {
						if (data["code"] > 0) {
							showMessage('success', data["message"],"<?php echo __URL('ADMIN_MAIN/promotion/promotionGamesList'); ?>");
						}else if(data["code"] == -1){
	...
	$("#dialog").dialog({
		buttons: {
			"确定": function() {
				$.ajax({
					type:"post",
					url : "<?php echo __URL('ADMIN_MAIN/promotion/closePromotionGame'); ?>",
					data : { "game_id" : game_id},
					dataType : "json",
					success : function(data) {
						if (data["code"] > 0) {
