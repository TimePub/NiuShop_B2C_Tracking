<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:37:"template/adminblue\Cms\topicList.html";i:1522739314;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="options-btn">
	...
	<button class="btn-common" onclick="location.href='<?php echo __URL('ADMIN_MAIN/cms/addtopic'); ?>';">添加专题</button>
</div>
...
function LoadingInfo(page_index) {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/cms/topiclist'); ?>",
		data : {
		...
		buttons: {
			"确定": function() {
				...
				if(!flag){
					...
					$.ajax({
						type : "post",
						url : "<?php echo __URL('ADMIN_MAIN/cms/deletetopic'); ?>",
						data : {
