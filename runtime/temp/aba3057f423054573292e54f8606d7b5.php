<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:38:"template/adminblue\Shop\sinceList.html";i:1522727994;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:44:"template/adminblue\Express\expressTitle.html";i:1522053049;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		...
		<table class="mytable">
			<tr>
				<td width="20%" style="text-align: left;">
					...
					<button style="margin:0 5px 0 0 !important;" class="btn-common btn-small" onclick="location.href='<?php echo __URL('ADMIN_MAIN/shop/addpickuppoint'); ?>';">添加门店</button>
				</td>
				<td width="20%">
...
function LoadingInfo(page_index) {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/shop/pickuppointlist'); ?>",
		data : {
		...
		buttons: {
			"确定": function() {
				...
				if(!flag){
					...
					$.ajax({
						type : "post",
						url : "<?php echo __URL('ADMIN_MAIN/shop/deletepickuppoint'); ?>",
						data : {
