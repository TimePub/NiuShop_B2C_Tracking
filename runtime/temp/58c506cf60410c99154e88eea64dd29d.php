<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:51:"template/adminblue\Express\freightTemplateList.html";i:1522669943;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="options-btn">
	<button class="btn-common-delete" onclick="batchDelete()" style="margin:0 !important;">批量删除</button>
	<button class="btn-common" onclick="location.href='<?php echo __URL('ADMIN_MAIN/express/freighttemplateedit?co_id='.$co_id); ?>';">添加模板</button>
</div>
<table class="list">
	<colgroup>
		<col style="width: 10%;">
...
function LoadingInfo(page_index){
	$.ajax({
		url: "<?php echo __URL('ADMIN_MAIN/express/freighttemplatelist'); ?>",
		type: 'POST',
		dataType: 'html',
		...
		success: function(data) {
			...
			$("#pageNumber").html(pagenumShow(jumpNumber,$("#pagecount").val(),<?php echo $pageshow; ?>));
		}
	});
}
	...
	$( "#dialog" ).dialog({
		buttons: {
			"确定": function() {
				...
				$.ajax({
					type:"post",
					url : "<?php echo __URL('ADMIN_MAIN/express/freighttemplatedelete'); ?>",
