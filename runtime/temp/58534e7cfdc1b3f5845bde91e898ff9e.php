<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:47:"template/adminblue\Dbdatabase\sqlFileQuery.html";i:1522728848;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
function sqlQuery(){
	...
	if(!flag){
		$.ajax({
			type:"post",
			url:"<?php echo __URL('ADMIN_MAIN/dbdatabase/sqlfilequery'); ?>",
			data:{"sql_text":sql},
...
function uploadSqlFile(){
	...
	if(name != ''){
		...
		if(name.indexOf("lqs.") === 0){
			if(file.type == ""){
				$.ajaxFileUpload({
					url : "<?php echo __URL('APP_MAIN/upload/uploadSql'); ?>", //用于文件上传的服务器端请求地址
