<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:45:"template/adminblue\Promotion\mansongList.html";i:1522725456;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<table class="mytable">
	<tr>
		<th width="10%" style="text-align: left;">
			...
			<button style="margin:0 5px 0 0 !important;" class="btn-common btn-small" onclick="location.href='<?php echo __URL('ADMIN_MAIN/promotion/addmansong'); ?>';">添加满减送</button>
		</th>
		<th width="10%">
...
function LoadingInfo(page_index) {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/promotion/mansonglist'); ?>",
		data : {
...
function closeMansong(mansong_id){
	$.ajax({
		type:"post",
		url : "<?php echo __URL('ADMIN_MAIN/promotion/closemansong'); ?>",
...
function delMansong(mansong_id){
	$.ajax({
		type:"post",
		url : "<?php echo __URL('ADMIN_MAIN/promotion/delmansong'); ?>",
...
function mansongInfo(mansong_id){
	...
	$.ajax({
		type:"get",
		url : "<?php echo __URL('ADMIN_MAIN/promotion/getmansongdetail'); ?>",
		data : { "mansong_id" : mansong_id },
		success : function(data) {
...
function CheckAll(event){
	...
	if(checked) $(".table-class tbody input[type = 'checkbox'][name='sub_no_use']").prop("checked",checked).parent("i").addClass('selected');
	else $(".table-class tbody input[type = 'checkbox'][name='sub_no_use']").prop("checked",checked).parent("i").removeClass('selected');
}
