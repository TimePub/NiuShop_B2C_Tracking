<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:43:"template/adminblue\Goods\goodsSpecList.html";i:1523353684;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
	...
	$.ajax({
		...
		success: function (data) {
			if(data['code'] > 0){
				if(name == 'is_visible'){
					if(value == 1){
						$("#isvisible_"+id).html('<img src="ADMIN_IMG/checked.png" alt="" width="15"/>');
						$("#isvisible_"+id).attr("is_visible", '0');
					}else{
						$("#isvisible_"+id).html('<img src="ADMIN_IMG/un_checked.png" alt="" width="15"/>');
						$("#isvisible_"+id).attr("is_visible", '1');
					}
				}
				if(name == 'is_screen'){
					if(value == 1){
						$("#isscreen_"+id).html('<img src="ADMIN_IMG/checked.png" alt="" width="15"/>');
						$("#isscreen_"+id).attr("is_screen", '0');
					}else{
						$("#isscreen_"+id).html('<img src="ADMIN_IMG/un_checked.png" alt="" width="15"/>');
		...
		success : function(data) {
			if (data["data"].length > 0) {
				...
				for (var i = 0; i < data["data"].length; i++) {
					...
					html += '<td style="overflow:hidden; text-overflow: ellipsis;text-align: left;">' + data["data"][i]["spec_value_name_list"] + '</td>';
