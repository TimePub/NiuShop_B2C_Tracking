<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:42:"template/adminblue\Config\visitConfig.html";i:1521193266;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
		...
		<dd>
			<div class="total">
				...
				<label for="navigationtype1" class="radio inline normal">
					<i class="radio-common <?php if($website['web_status'] == 1): ?>selected<?php endif; ?>">
						<input type="radio" value="1" name="navigationtype" id="navigationtype1"  <?php if($website['web_status'] == 1): ?>checked<?php endif; ?>/>
					</i>
					<span>开启</span>
				</label>
				<label for="navigationtype2" class="radio inline normal">
					<i class="radio-common <?php if($website['web_status'] == 2): ?>selected<?php endif; ?>">
						<input type="radio" value="2" name="navigationtype" id="navigationtype2"  <?php if($website['web_status'] == 2): ?>checked<?php endif; ?>/>
					</i>
					<span>关闭</span>
				</label>
				<label for="navigationtype3" class="radio inline normal">
					<i class="radio-common <?php if($website['web_status'] == 3): ?>selected<?php endif; ?>">
						<input type="radio" value="3" name="navigationtype" id="navigationtype3"  <?php if($website['web_status'] == 3): ?>checked<?php endif; ?>/>
					</i>
					<span>关闭后访问WAP端</span>
				</label>
			</div>
		...
		<dd>
			<div class="total">
				<label for="waptype1" class="radio inline normal">
					<i class="radio-common <?php if($website['wap_status'] == 1): ?>selected<?php endif; ?>">
						<input type="radio" value="1" name="waptype" id="waptype1"  <?php if($website['wap_status'] == 1): ?>checked<?php endif; ?>/>
					</i>
					<span>开启</span>
				</label>
				<label for="waptype2" class="radio inline normal">
					<i class="radio-common <?php if($website['wap_status'] == 2): ?>selected<?php endif; ?>">
						<input type="radio" value="2" name="waptype" id="waptype2" <?php if($website['wap_status'] == 2): ?>checked<?php endif; ?>/>
					</i>
					<span>关闭</span>
				</label>
				<label for="waptype3" class="radio inline normal">
					<i class="radio-common <?php if($website['wap_status'] == 3): ?>selected<?php endif; ?>">
						<input type="radio" value="3" name="waptype" id="waptype3" <?php if($website['wap_status'] == 3): ?>checked<?php endif; ?>/>
					</i>
					<span>关闭后访问PC端</span>
				</label>
			</div>
	...
	<dl  class="reason">
		<dt>网站关闭原因：</dt>
		<dd>
			<textarea name="store_zy" rows="2" id="close_reason" class="textarea-common"><?php echo $website['close_reason']; ?></textarea>
...
function setConfigAjax() {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/config/visitconfig'); ?>",
		data : {
		...
		success : function(data) {
			if (data["code"] > 0) {
				...
				window.location.href = "<?php echo __URL('ADMIN_MAIN/config/visitconfig'); ?>";
			} else {
