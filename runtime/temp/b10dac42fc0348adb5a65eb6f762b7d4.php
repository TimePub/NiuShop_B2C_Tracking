<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:42:"template/adminblue\Promotion\giftList.html";i:1522725456;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<table class="mytable">
	<tr>
		<th width="20%" style="text-align:left;"><button class="btn-common btn-small" onclick="location.href='<?php echo __URL('ADMIN_MAIN/promotion/addgift'); ?>';" style="margin:0 5px 0 0 !important;">添加赠品</button></th>
		<th width="10%">
...
function giftInfo(gift_id){
	...
	$.ajax({
		type:"post",
		url : "<?php echo __URL('ADMIN_MAIN/promotion/getgiftinfo'); ?>",
...
function deleteGift(gift_id){
	$( "#dialog" ).dialog({
		buttons: {
			...
			$.ajax({
				type : "post",
				url : "<?php echo __URL('ADMIN_MAIN/promotion/deleteGift'); ?>",
				data : {"gift_id" : gift_id},
				success : function(data) {
					if(data["code"] > 0 ){
						LoadingInfo(1);
