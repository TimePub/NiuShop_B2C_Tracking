...
<div class="service-guarantee">
	<table class="table-class">
		...
		<tr data-flag="<?php echo $vo['id']; ?>">
			<td align="center">
				<div class="shop_service_item" >
					<input class="input-file" name="file_upload" id="uploadImg<?php echo $key; ?>" type="file" onchange="imgUpload(this);" style="cursor: pointer;width: 30px;margin-top: 12px;margin-left: 62px;" title=" " >
					<input type="hidden" id="logo<?php echo $key; ?>" value="<?php echo $vo['pic']; ?>" class="sg-pic" >
					<?php if($vo['pic'] == ''): ?>
					<img id="imglogo<?php echo $key; ?>" src="__STATIC__/blue/img/goods_sku_add.png" style="cursor: pointer;width:28px;height:28px;">
					<?php else: ?>
					<img src="<?php echo $vo['pic']; ?>" id="imglogo<?php echo $key; ?>" style="cursor: pointer;width:28px;height:28px;" class="black_data">
			...
			<td align="center">
				<input type="text" placeholder="请输入商家服务标题" class="input-common sg-title" value="<?php echo $vo['title']; ?>"/>
			</td>
			<td align="center">
				<input type="text" placeholder="请输入商家服务描述" class="input-common sg-describe" value="<?php echo $vo['describe']; ?>"/>
			</td>
		</tr>
		<?php endforeach; endif; else: echo "" ;endif; ?>
		<tr>
...
<script>
 var UPLOADICO = '<?php echo UPLOAD_ICO; ?>';
...
// 	alert(JSON.stringify(value));die;
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/config/merchantService'); ?>",
