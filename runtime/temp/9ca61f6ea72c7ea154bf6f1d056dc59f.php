<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:36:"template/adminblue\Wchat\config.html";i:1522745592;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	...
	<dl>
		<dt>APPID：</dt>
		<dd>
			<input class="span2 input-common" id="appid" placeholder="AppID" value="<?php echo $wchat_config['appid']; ?>" type="text" style="width:220px;">
	...
	<dl>
		<dt>APP密钥：</dt>
		<dd>
			<input class="span2 input-common" id="appsecret" type="text" placeholder="Appsecret" value="<?php echo $wchat_config['appsecret']; ?>" style="width:220px;">
	...
	<dl>
		<dt>URL：</dt>
		<dd>
			<input type="text" class="input-commmon" style="background-color: white; box-shadow: none; border: none;border-radius:0;min-width: 450px;display: inline-block;" readonly="readonly" id="empowerUrl" value="<?php echo $call_back_url; ?>">
	...
	<dl>
		<dt>Token：</dt>
		<dd>
			<input type="text" class="input-common" style="background-color: white; min-width: 458px;display: inline-block;" id="empowerToken" value="<?php echo $wchat_config['token']; ?>" maxlength="32" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')" onpaste="return false">
