<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:47:"template/adminblue\Saleservice\consultList.html";i:1522725456;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
	...
	<tr>
		...
		<td>
			...
			<div class="more-search-container">
				<dl>
					<dt>商品名称：</dt>
					<dd><input id="goods_name" class="input-medium input-common middle" type="text" placeholder="请输入商品名称" ></dd>
				</dl>
				<dl>
					<dt>咨询类型：</dt>
					<dd>
		...
		success : function(data) {
			if (data["data"].length > 0) {
				...
				for (var i = 0; i < data["data"].length; i++) {
					...
					html += '<td colspan="2"  align="left" style="border-left:1px solid #e5e5e5;"><a href="'+__URL('SHOP_MAIN/goods/goodsinfo?goodsid='+ data["data"][i]["goods_id"])+'" target="_blank">'+ data["data"][i]["goods_name"] + '</a></td>';
