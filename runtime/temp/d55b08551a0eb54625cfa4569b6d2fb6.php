<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:45:"template/adminblue\Config\expressMessage.html";i:1523965637;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:44:"template/adminblue\Express\expressTitle.html";i:1522053049;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		...
		<h4>物流跟踪设置</h4>
			<div class="set-style">
				<dl>
					...
					<dd>
						<select name="" id="type" class="select-common">
							<option value="1" <?php if($emconfig['value']['type'] == 1): ?>selected<?php endif; ?>>快递鸟</option>
						</select>
					</dd>
				</dl>
				<dl id="Js-appid" <?php if($emconfig['value']['type'] != 1): ?>style="display:none;"<?php endif; ?>>
					<dt>APPID：</dt>
					<dd>
						<input id="appid" type="text" value="<?php echo $emconfig['value']['appid']; ?>" class="input-common long"/>
				...
				<dl>
					<dt>APPKEY：</dt>
					<dd>
						<input id="appkey" type="text" value="<?php echo $emconfig['value']['appkey']; ?>" class="input-common long"/>
						<p class="hint">应用密钥</p>
					</dd>
				</dl>
				<dl>
					<dt>说明：</dt>
					<dd>
						<a id="apply_address" href="<?php if($emconfig['value']['type'] != 1): ?>http://www.kuaidi100.com/<?php else: ?>http://www.kdniao.com/<?php endif; ?>" target="_blank" id="">点击申请</a>&nbsp;&nbsp;&nbsp;
				...
				<dl>
					...
					<dd>
						<div class="controls">
							<p>
								<input id="is_use" type="checkbox"  class="checkbox" <?php if($emconfig['is_use'] == 1): ?>checked<?php endif; ?>/>
							</p>
						</div>
					</dd>
				</dl>
...
function setExpressConfigAjax(){
	...
	$.ajax({
		type:"post",
		url : "<?php echo __URL('ADMIN_MAIN/config/expressmessage'); ?>",
		data : {
			"type" : type,
			"appid" : appid,
			"appkey":appkey,
		...
		success : function(data){
			if(data['code'] > 0){
				...
				location.href = "<?php echo __URL('ADMIN_MAIN/config/expressmessage'); ?>";
			}else{
