<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:43:"template/adminblue\Config\payAliConfig.html";i:1523962792;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		<dt>账号：</dt>
		<dd>
			<input id="ali_seller" type="text" value="<?php echo $config['value']['ali_seller']; ?>" class="input-common long" />
	...
	<dl>
		<dt>合作者身份ID：</dt>
		<dd>
			<input id="ali_partnerid" type="text" value="<?php echo $config['value']['ali_partnerid']; ?>" class="input-common long" />
		...
		<dt>安全校验码：</dt>
		<dd>
			<input id="ali_key" type="text" value="<?php echo $config['value']['ali_key']; ?>" class="input-common long" />
	...
	<dl>
		...
		<dd>
			...
			<?php if($original_road_refund_setting_info['is_use']): ?>checked="checked"<?php endif; ?>
			/></p>
	...
	<dl style="display:none">
		...
		<dd>
			...
			<?php if($transfer_accounts_setting_info['is_use']): ?>checked="checked"<?php endif; ?>
			/></p>
			<p class="hint">开启支付宝支付才可以进行后续操作</p>
		</dd>
	</dl>
...
function setConfigAjax(){
	...
	$.ajax({
		type:"post",
		url:"<?php echo __URL('ADMIN_MAIN/config/alipayconfig'); ?>",
		data:{
