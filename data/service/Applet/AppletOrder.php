...
class AppletOrder extends BaseService
{
    ...
    public function getOrderDetail($order_id)
    {
        ...
        $promotion_detail = $ns_order_promotion -> getInfo(["order_id"=>$order_id],"promotion_type");
