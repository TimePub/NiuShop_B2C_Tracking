 ...
 * 订单操作类
 */
class AppletOrderBusiness extends BaseService
{
...
; // datetime NOT NULL DEFAULT 'CURRENT_TIMESTAMP' COMMENT '订单创建时间',
            ...
            // 添加订单项
            $order_goods = new AppletOrderGoods();
            $res_order_goods = $order_goods->addOrderGoods($buyer_uid, $order_id, $goods_sku_list);
...
; // datetime NOT NULL DEFAULT 'CURRENT_TIMESTAMP' COMMENT '订单创建时间',
     ...
     *
     * @param unknown $order_goods_id            
     * @return multitype:|Ambigous , \think\false, \think\Collection, \think\db\false, PDOStatement, string, \PDOStatement, \think\db\mixed, boolean, unknown, \think\mixed, multitype:, array>
     */
