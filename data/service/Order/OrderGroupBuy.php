...
class OrderGroupBuy extends Order
{
     ...
     */
    public function orderCreateGroupBuy($order_type, $out_trade_no, $pay_type, $shipping_type, $order_from, $buyer_ip, $buyer_message, $buyer_invoice, $shipping_time, $receiver_mobile, $receiver_province, $receiver_city, $receiver_district, $receiver_address, $receiver_zip, $receiver_name, $point, $user_money, $goods_sku_list, $platform_money, $pick_up_id, $shipping_company_id, $coin, $fixed_telephone = "")
    {
    ...
    public function addOrderGoods($order_id, $goods_sku_list)
    {
        ...
        try {
            ...
            foreach ($goods_sku_list_array as $k => $goods_sku_array) {
                ...
                $sku_price = $this->getGoodsGroupBuyPrice($goods_sku_info['goods_id'],1);
                $goods_promote_info = '';
