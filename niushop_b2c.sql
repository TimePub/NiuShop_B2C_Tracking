...
-- Table test_niushop_b2c.nc_cms_article does not contain any data (it is empty)

-- 
-- Dumping data for table nc_cms_article_class
--

-- Table test_niushop_b2c.nc_cms_article_class does not contain any data (it is empty)

-- 
-- Dumping data for table nc_cms_comment
--

-- Table test_niushop_b2c.nc_cms_comment does not contain any data (it is empty)

-- 
-- Dumping data for table nc_cms_topic
--

-- Table test_niushop_b2c.nc_cms_topic does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account
--

-- Table test_niushop_b2c.ns_account does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_assistant_records
--

-- Table test_niushop_b2c.ns_account_assistant_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_order_records
--

-- Table test_niushop_b2c.ns_account_order_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_period
--

-- Table test_niushop_b2c.ns_account_period does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_records
--

-- Table test_niushop_b2c.ns_account_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_return_records
--

-- Table test_niushop_b2c.ns_account_return_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_withdraw_records
--

-- Table test_niushop_b2c.ns_account_withdraw_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_withdraw_user_records
--

-- Table test_niushop_b2c.ns_account_withdraw_user_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_attribute
--

-- Table test_niushop_b2c.ns_attribute does not contain any data (it is empty)

-- 
-- Dumping data for table ns_attribute_value
--

-- Table test_niushop_b2c.ns_attribute_value does not contain any data (it is empty)

-- 
-- Dumping data for table ns_cart
--

-- Table test_niushop_b2c.ns_cart does not contain any data (it is empty)

-- 
-- Dumping data for table ns_click_fabulous
--

-- Table test_niushop_b2c.ns_click_fabulous does not contain any data (it is empty)

-- 
-- Dumping data for table ns_consult
--

-- Table test_niushop_b2c.ns_consult does not contain any data (it is empty)

-- 
-- Dumping data for table ns_consult_type
--

-- Table test_niushop_b2c.ns_consult_type does not contain any data (it is empty)

-- 
-- Dumping data for table ns_coupon
--

-- Table test_niushop_b2c.ns_coupon does not contain any data (it is empty)

-- 
-- Dumping data for table ns_coupon_goods
--

-- Table test_niushop_b2c.ns_coupon_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_coupon_type
--

-- Table test_niushop_b2c.ns_coupon_type does not contain any data (it is empty)

-- 
-- Dumping data for table ns_express_company
--

-- Table test_niushop_b2c.ns_express_company does not contain any data (it is empty)

-- 
-- Dumping data for table ns_express_shipping
--

-- Table test_niushop_b2c.ns_express_shipping does not contain any data (it is empty)

-- 
-- Dumping data for table ns_express_shipping_items
--

-- Table test_niushop_b2c.ns_express_shipping_items does not contain any data (it is empty)
...
-- Table test_niushop_b2c.ns_gift_grant_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods
--

-- Table test_niushop_b2c.ns_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_attribute
--

-- Table test_niushop_b2c.ns_goods_attribute does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_attribute_deleted
--

-- Table test_niushop_b2c.ns_goods_attribute_deleted does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_attribute_value
--

-- Table test_niushop_b2c.ns_goods_attribute_value does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_brand
--

-- Table test_niushop_b2c.ns_goods_brand does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_category
--

-- Table test_niushop_b2c.ns_goods_category does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_category_block
--

-- Table test_niushop_b2c.ns_goods_category_block does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_comment
--

-- Table test_niushop_b2c.ns_goods_comment does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_deleted
--

-- Table test_niushop_b2c.ns_goods_deleted does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_evaluate
--

-- Table test_niushop_b2c.ns_goods_evaluate does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_group
--

-- Table test_niushop_b2c.ns_goods_group does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_sku
--

-- Table test_niushop_b2c.ns_goods_sku does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_sku_deleted
--

-- Table test_niushop_b2c.ns_goods_sku_deleted does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_sku_picture
--

-- Table test_niushop_b2c.ns_goods_sku_picture does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_sku_picture_delete
--

-- Table test_niushop_b2c.ns_goods_sku_picture_delete does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_spec
--

-- Table test_niushop_b2c.ns_goods_spec does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_spec_value
--

-- Table test_niushop_b2c.ns_goods_spec_value does not contain any data (it is empty)
...
-- Table test_niushop_b2c.ns_member_account does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_account_records
--

-- Table test_niushop_b2c.ns_member_account_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_balance_withdraw
--

-- Table test_niushop_b2c.ns_member_balance_withdraw does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_bank_account
--

-- Table test_niushop_b2c.ns_member_bank_account does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_express_address
--

-- Table test_niushop_b2c.ns_member_express_address does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_favorites
--

-- Table test_niushop_b2c.ns_member_favorites does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_gift
--

-- Table test_niushop_b2c.ns_member_gift does not contain any data (it is empty)
...
-- Table test_niushop_b2c.ns_member_recharge does not contain any data (it is empty)

-- 
-- Dumping data for table ns_notice
--

-- Table test_niushop_b2c.ns_notice does not contain any data (it is empty)

-- 
-- Dumping data for table ns_offpay_area
--

-- Table test_niushop_b2c.ns_offpay_area does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order
--

-- Table test_niushop_b2c.ns_order does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_action
--

-- Table test_niushop_b2c.ns_order_action does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_goods
--

-- Table test_niushop_b2c.ns_order_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_goods_express
--

-- Table test_niushop_b2c.ns_order_goods_express does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_goods_promotion_details
--

-- Table test_niushop_b2c.ns_order_goods_promotion_details does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_payment
--

-- Table test_niushop_b2c.ns_order_payment does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_pickup
--

-- Table test_niushop_b2c.ns_order_pickup does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_promotion_details
--

-- Table test_niushop_b2c.ns_order_promotion_details does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_refund
--

-- Table test_niushop_b2c.ns_order_refund does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_refund_account_records
--

-- Table test_niushop_b2c.ns_order_refund_account_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_shipping_fee
--

-- Table test_niushop_b2c.ns_order_shipping_fee does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_shop_return
--

-- Table test_niushop_b2c.ns_order_shop_return does not contain any data (it is empty)

-- 
-- Dumping data for table ns_pickup_point
--

-- Table test_niushop_b2c.ns_pickup_point does not contain any data (it is empty)

-- 
-- Dumping data for table ns_platform_adv
--

-- Table test_niushop_b2c.ns_platform_adv does not contain any data (it is empty)
...
-- Table test_niushop_b2c.ns_platform_block does not contain any data (it is empty)

-- 
-- Dumping data for table ns_platform_goods_recommend
--

-- Table test_niushop_b2c.ns_platform_goods_recommend does not contain any data (it is empty)

-- 
-- Dumping data for table ns_platform_goods_recommend_class
--

-- Table test_niushop_b2c.ns_platform_goods_recommend_class does not contain any data (it is empty)
...
-- Table test_niushop_b2c.ns_platform_link does not contain any data (it is empty)

-- 
-- Dumping data for table ns_point_config
--

-- Table test_niushop_b2c.ns_point_config does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_bundling
--

-- Table test_niushop_b2c.ns_promotion_bundling does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_bundling_goods
--

-- Table test_niushop_b2c.ns_promotion_bundling_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_discount
--

-- Table test_niushop_b2c.ns_promotion_discount does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_discount_goods
--

-- Table test_niushop_b2c.ns_promotion_discount_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_full_mail
--

-- Table test_niushop_b2c.ns_promotion_full_mail does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_gift
--

-- Table test_niushop_b2c.ns_promotion_gift does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_gift_goods
--

-- Table test_niushop_b2c.ns_promotion_gift_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_mansong
--

-- Table test_niushop_b2c.ns_promotion_mansong does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_mansong_goods
--

-- Table test_niushop_b2c.ns_promotion_mansong_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_mansong_rule
--

-- Table test_niushop_b2c.ns_promotion_mansong_rule does not contain any data (it is empty)
...
-- Table test_niushop_b2c.ns_shop does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_ad
--

-- Table test_niushop_b2c.ns_shop_ad does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_coin_records
--

-- Table test_niushop_b2c.ns_shop_coin_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_express_address
--

-- Table test_niushop_b2c.ns_shop_express_address does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_group
--

-- Table test_niushop_b2c.ns_shop_group does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_navigation
--

-- Table test_niushop_b2c.ns_shop_navigation does not contain any data (it is empty)
...
-- Table test_niushop_b2c.ns_shop_order_account_records does not contain any data (it is empty)
...
-- Table test_niushop_b2c.ns_supplier does not contain any data (it is empty)

-- 
-- Dumping data for table ns_virtual_goods
--

-- Table test_niushop_b2c.ns_virtual_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_virtual_goods_group
--

-- Table test_niushop_b2c.ns_virtual_goods_group does not contain any data (it is empty)

-- 
-- Dumping data for table ns_virtual_goods_type
--

-- Table test_niushop_b2c.ns_virtual_goods_type does not contain any data (it is empty)

-- 
-- Dumping data for table sys_addons
--

-- Table test_niushop_b2c.sys_addons does not contain any data (it is empty)
...
-- Table test_niushop_b2c.sys_album_picture does not contain any data (it is empty)
...
-- Table test_niushop_b2c.sys_custom_template does not contain any data (it is empty)
...
-- Table test_niushop_b2c.sys_instance_type does not contain any data (it is empty)
...
(151, '商品发布', 'admin', 'goods', 'addgoods', 149, 2, 'goods/addgoods', 1, 0, 2, '相关教程：<a href="http://bbs.niushop.com.cn/forum.php?mod=viewthread&tid=2302&extra=page%3D3" target="_blank">http://bbs.niushop.com.cn/forum.php?mod=viewthread&tid=2302&extra=page%3D3</a>', '', '', 1, 1479268307, NULL),
...
(423, '商品品牌', 'admin', 'goods', 'goodsbrandlist', 149, 2, 'goods/goodsbrandlist', 1, 0, 3, '相关教程：<a href="http://bbs.niushop.com.cn/forum.php?mod=viewthread&tid=2304&extra=page%3D3" target="_blank">http://bbs.niushop.com.cn/forum.php?mod=viewthread&tid=2304&extra=page%3D3</a>', '', '', 1, 1492756038, NULL),
...
(463, '商品分析', 'admin', 'account', 'shopgoodssaleslist', 409, 2, 'account/shopgoodssaleslist', 1, 0, 2, '相关教程：<a href="http://bbs.niushop.com.cn/forum.php?mod=viewthread&tid=2325&extra=page%3D2" target="_blank">http://bbs.niushop.com.cn/forum.php?mod=viewthread&tid=2325&extra=page%3D2</a>', '', '', 1, 1493949799, NULL),
...
(478, '商品评价', 'admin', 'goods', 'goodscomment', 149, 2, 'goods/goodscomment', 1, 0, 8, '相关教程：<a href="http://bbs.niushop.com.cn/forum.php?mod=viewthread&tid=2311&extra=page%3D2" target="_blank">http://bbs.niushop.com.cn/forum.php?mod=viewthread&tid=2311&extra=page%3D2</a>', '', '', 1, 1496310914, NULL),
...
(10088, '虚拟商品类型', 'admin', 'goods', 'virtualgoodstypelist', 149, 2, 'goods/virtualgoodstypelist', 1, 0, 3, '相关教程：<a href="http://bbs.niushop.com.cn/forum.php?mod=viewthread&tid=2305&extra=page%3D3" target="_blank">http://bbs.niushop.com.cn/forum.php?mod=viewthread&tid=2305&extra=page%3D3</a>', '', '', 1, 1512180139, 0),
(10089, '编辑虚拟商品类型', 'admin', 'goods', 'editvirtualgoodstype', 10088, 3, 'goods/editvirtualgoodstype', 0, 0, 1, '', '', '', 1, 1512180139, 0),
(10090, '虚拟订单', 'admin', 'order', 'virtualorderlist', 184, 2, 'order/virtualorderlist', 1, 0, 2, '', '', '', 1, 1512180139, 0),
...
-- Table test_niushop_b2c.sys_notice_records does not contain any data (it is empty)

-- 
-- Dumping data for table sys_notice_template
--

-- Table test_niushop_b2c.sys_notice_template does not contain any data (it is empty)
...
(1, 0, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 1, '', 1, 1, '', 0, '', '', '', '', 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, '', 0, '', 'admin', '', 0, 0, 0, 2018, 0, 0, 0);
...
-- Table test_niushop_b2c.sys_user_log does not contain any data (it is empty)

-- 
-- Dumping data for table sys_version_devolution
--

-- Table test_niushop_b2c.sys_version_devolution does not contain any data (it is empty)

-- 
-- Dumping data for table sys_version_patch
--

-- Table test_niushop_b2c.sys_version_patch does not contain any data (it is empty)

-- 
-- Dumping data for table sys_version_update_records
--

-- Table test_niushop_b2c.sys_version_update_records does not contain any data (it is empty)
...
-- Table test_niushop_b2c.sys_weixin_auth does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_default_replay
--

-- Table test_niushop_b2c.sys_weixin_default_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_fans
--

-- Table test_niushop_b2c.sys_weixin_fans does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_follow_replay
--

-- Table test_niushop_b2c.sys_weixin_follow_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_functions_button
--

-- Table test_niushop_b2c.sys_weixin_functions_button does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_instance_msg
--

-- Table test_niushop_b2c.sys_weixin_instance_msg does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_key_replay
--

-- Table test_niushop_b2c.sys_weixin_key_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_media
--

-- Table test_niushop_b2c.sys_weixin_media does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_media_item
--

-- Table test_niushop_b2c.sys_weixin_media_item does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_menu
--

-- Table test_niushop_b2c.sys_weixin_menu does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_msg_template
--

-- Table test_niushop_b2c.sys_weixin_msg_template does not contain any data (it is empty)
...
ALTER TABLE sys_website ADD COLUMN is_show_follow smallint(1) NOT NULL DEFAULT 1 COMMENT 'wap端是否显示顶部关注';
-- 
-- Dumping data for table sys_weixin_user_msg
--

-- Table test_niushop_b2c.sys_weixin_user_msg does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_user_msg_replay
--

-- Table test_niushop_b2c.sys_weixin_user_msg_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_wexin_onekeysubscribe
--

-- Table test_niushop_b2c.sys_wexin_onekeysubscribe does not contain any data (it is empty)
