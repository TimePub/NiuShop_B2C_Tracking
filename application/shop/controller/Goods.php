...
class Goods extends BaseController
{
    ...
    public function goodsinfoNew()
    {
        ...
        $goods_info = $this->goods->getBasisGoodsDetail('24558');
    }
    ...
    public function goodsinfo($goodsid)
    {
        ...
        if (! empty($goodsid)) {
            ...
            if ($default_client == "shop") {} elseif (request()->isMobile() && $web_info['wap_status'] == 1) {
            ...
            // 商品阶梯优惠
            $goodsLadderPreferentialList = '';
            $this->assign("goodsLadderPreferentialList", '');
            $this->assign("goodsLadderPreferentialListStr", '');
    ...
    public function goodsList()
    {
        ...
        $goods_list = $this->getGoodsListByConditions($category_id, $brand_id, $min_price, $max_price, $keyword, $page, PAGESIZE, $orderby, $shipping_fee, $stock, $platform_proprietary, $province_id, $attr_array, $spec_array);
     ...
     * @return \think\response\View
     */
    public function goodsInfoPointExchange($goodsid)
    {
        $this->goods_category = new GoodsCategoryService();
        $web_info = $this->web_site->getWebSiteInfo();
        if (empty($goodsid)) {
